  ...
  <div id="app">
    ...
    <header v-if="showHeader" class="bg-gradient-to-r from-blue-600 to-indigo-700 text-white shadow-lg py-4 px-6 flex items-center justify-between">
      ...
      <div class="flex items-center space-x-4">
        <button
          v-if="route.path !== '/bigscreen'"
          @click="goToBigscreen"
          class="text-sm bg-purple-500 hover:bg-purple-600 px-3 py-1 rounded-full transition"
        >
          大屏监测
        </button>
...
const showHeader = computed(() => {
  return route.path !== '/login' && route.path !== '/bigscreen'
})
